...
results:any={};
currentUser: any;
constructor(private token: TokenStorageService,private settingservice :SettingserviceService, private uploadservice:UploadserviceService,private studentservice:StudentService) { }
