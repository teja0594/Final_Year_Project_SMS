...
@Component({
  selector: 'app-profileresults2',
  templateUrl: './profileresults2.component.html',
  styleUrls: ['./profileresults2.component.css']
})
export class Profileresults2Component implements OnInit {
  @ViewChild(MatAccordion) accordion: MatAccordion;

  constructor(private token: TokenStorageService, private uploadservice:UploadserviceService,private studentservice:StudentService,private _service:SettingserviceService) { }
  grades: Grade[] = [
    {g:'O',gp:10},
    {g:'A+',gp:9},
    {g:'A',gp:8},
...
currentUser: any;
  ...
  retrieveTutorials(): void {
    this.uploadservice.findByTitle(this.currentUser)
    .subscribe(
      data => {
